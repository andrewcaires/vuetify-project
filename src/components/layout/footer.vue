<template>
  <v-footer app height="40">
    <NuxtLink v-for="item in items" :key="item.title" class="d-inline-block mx-2 social-link" :href="item.href"
    ...
    <div class="text-caption text-disabled" style="position: absolute; right: 16px;">
      ...
      —
      <NuxtLink class="text-decoration-none on-surface" href="https://vuetifyjs.com/about/licensing/"
